...
function Locale2Flag(locale) {
  ...
  var a = String.fromCodePoint(code.codePointAt(0) - 0x41 + 0x1F1E6);
  var b = String.fromCodePoint(code.codePointAt(1) - 0x41 + 0x1F1E6);
  return a + b;
}

/* harmony default export */ __webpack_exports__["a"] = (Locale2Flag);
...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.component('switch-locale-dropdown', __webpack_require__(12));
  Vue.component('index-switch-locale', __webpack_require__(17));
  Vue.component('detail-switch-locale', __webpack_require__(20));
  Vue.component('form-switch-locale', __webpack_require__(23));

  if (window.config.customDetailToolbar) {
    Vue.component('custom-detail-toolbar', __webpack_require__(27));
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flag_js__ = __webpack_require__(1);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    computed: {
        flag: function flag() {
            return Object(__WEBPACK_IMPORTED_MODULE_0__flag_js__["a" /* default */])(Nova.config.locale);
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Current Locale")]),
      _vm._v(" "),
      _c(
        "card",
        {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5d486d99", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    Nova.request().get('/nova-vendor/switch-locale/languages').then(function (response) {
      _this.locales = response.data.locales;
      _this.allowed = response.data.allowed;
    });
  },
  ...
  methods: {
    switchLocale: function switchLocale(locale) {
      Nova.request().post('/nova-vendor/switch-locale/save-locale', {
        locale: locale
  ...
  filters: {
    flag: function flag(l) {
      return Object(__WEBPACK_IMPORTED_MODULE_0__flag_js__["a" /* default */])(l);
    }
  },
  computed: {
      ...
      _c("dropdown-trigger", { staticClass: "h-9 flex items-center" }, [
        ...
        _vm._v(
          "\n\n    " +
            ...
            " " +
            _vm._s(_vm._f("flag")(_vm.currentLocale)) +
            "\n  "
        )
      ]),
      _vm._v(" "),
                  ...
                  [
                    ...
                    _vm.allowed
                      ? _c("span", { staticClass: "float-right" }, [
                          _vm._v(_vm._s(_vm.allowed[locale] ? "🟢" : "🔴"))
                        ])
                      : _vm._e()
                  ]
                )
...
var render = function() {
  ...
  return _c(
    "span",
    { staticClass: "flex" },
    _vm._l(_vm.field.value.locale, function(l) {
      return _c("span", { key: l }, [
        _vm._v("\n    " + _vm._s(_vm._f("flag")(l)) + "\n  ")
      ])
    }),
    0
  )
      ...
      _c("div", { staticClass: "flex border-b border-40" }, [
        _c("div", { staticClass: "w-1/4 py-4" }, [
          _c("h4", { staticClass: "font-normal text-80" }, [
            _vm._v(
              _vm._s(_vm._f("flag")(_vm.field.locale)) +
                " " +
                _vm._s(_vm.currentLocaleName) +
                "?"
            )
        ...
        _c("div", { staticClass: "w-3/4 py-4" }, [
          _c("span", { staticClass: "mr-1" }, [
            _vm._v(_vm._s(_vm.field.value.isTranslated ? "🟢" : "🔴"))
          ]),
          _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'delete-toolbar-button': __webpack_require__(29)
  },
...
/* harmony default export */ __webpack_exports__["default"] = ({
   ...
   */
		...
		confirmDelete: function confirmDelete() {
			...
			Nova.request().post("/nova-vendor/switch-locale/delete?resourceId=" + this.resourceId + "&resourceName=" + this.resourceName, {
				_method: "DELETE"
			}).then(function (response) {
